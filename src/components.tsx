...
export const ManualNewsInputPanel = ({ isOpen, onClose, onSubmit, isLoading, error }: { isOpen: boolean, onClose: () => void, onSubmit: (topic: string, count: number) => void, isLoading: boolean, error: string | null }) => {
